...
def block_decoder(block_name,
    ...
    if block_name == 'last_unary':
        return LastUnaryBlock(in_dim, config.kpconv_out_dim, config.use_batch_norm, config.batch_norm_momentum)
...
class UnaryBlock(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, use_bn, bn_momentum, no_relu=True):
        """
